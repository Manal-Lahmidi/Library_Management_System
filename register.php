...
<html>
	...
	<body>
		<?php
		require('config.php');
		if (isset($_REQUEST['username'], $_REQUEST['statut'], $_REQUEST['email'], $_REQUEST['password'])){
			...
			$userstat = stripslashes($_REQUEST['statut']);
			...
			<form class="box" action="" method="post">
				...
				<input type="text" class="box-input" name="username" placeholder="Nom complet d'utilisateur" required />
				<label style="color: #717171; font-size:13px">*Enseignant ou *Etudiant</label><br>
				<input type="text" class="box-input" name="statut" placeholder="Statut d'utilisateur" required />
